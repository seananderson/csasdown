#' Get the document type, either 'pdf' or 'word'
#'
#' @param fn The name of the YAML file, typically 'index.Rmd' for bookdown
#'
#' @return A character string representing the document type
#' @export
get_doc_type <- function(fn = "index.Rmd"){
  if(!file.exists(fn)){
  ...
  # Get the render type from the `output:` tag
