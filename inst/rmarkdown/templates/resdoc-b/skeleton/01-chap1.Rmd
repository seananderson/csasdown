...
# This syntax means copy the exact contents from the chunk 'chap01-para-6-en'
# above into this chunk. This is a better than cutting and pasting the chunk
# contents in here manually. This should only appear in chunks with the 
# 'needs_trans = TRUE' option set in the knitr chunk header, as this one has
<<chap01-para-6-en>>
```
