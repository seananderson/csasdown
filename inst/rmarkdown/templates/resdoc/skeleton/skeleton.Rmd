...
#  the box with a 'Needs translation' tag in red.
...
#  This assumes you are translating from English to French.
...
#  
#  IMPORTANT NOTES
#  - You must use double backslashes in the chunks encapsulated by the 'cat()'
#  function. So anywhere you would normally use a single backslash, use double.
#  Examples are \@ref() becomes \\@ref(), \pi becomes \\pi
