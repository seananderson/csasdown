...
library(knitr)
if(is_latex_output()){
  knitr_figs_dir <- here::here("knitr-figs-pdf//")
  knitr_cache_dir <- here::here("knitr-cache-pdf//")
  fig_out_type <- "png"
}else{
  knitr_figs_dir <- here::here("knitr-figs-docx//")
  knitr_cache_dir <- here::here("knitr-cache-docx//")
  fig_out_type <- "png"
}
fig_asp <- 0.618
fig_width <- 9
