...
Within CSAS you should use the function `csasdown::csas_table()` instead. It just calls the function `kable()`, space say but it adds some default argument values that will make the tables render correctly in both LaTeX and in Word documents.
