...
```{r templates-3}
panel1.df <- tidyr::pivot_wider(sim.df[sim.df$panel.category == "SSB", ], names_from = "ts.name", values_from = "ts.value")
names(panel1.df) <- c("panel.category", "year", "SSB", "SSBlow", "SSBhigh", "SSBlrp", "SSBusr")
