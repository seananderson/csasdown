...
if (is.null(meta)) {
  # This knitr chunk was run in R without running bookdown::render_book("index.Rmd")
  # so the rmarkdown::meta data is not populated
...
csl <- "csl/csas.csl"
fr_toggle <- getOption("french")
if (is.null(fr_toggle)) {
  stop("french toggle was not set up correctly in YAML header in index.Rmd. ",
